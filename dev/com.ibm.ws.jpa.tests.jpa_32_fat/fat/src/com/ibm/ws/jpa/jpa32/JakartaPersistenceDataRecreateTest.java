...
import io.openliberty.jpa.persistence.tests.web.JakartaPersistenceDataRecreateServlet;

/**
 * Testing different cases of EclipseLink Recreate issues of Jakarta Persistence 3.2
 */
...
public class JakartaPersistenceDataRecreateTest {
    ...
    public static final String SERVLET = "JakartaPersistence32DataRecreate";
    public static final String SPECLEVEL = "3.2";

    @Server("JakartaPersistenceServer")
    @TestServlet(servlet = JakartaPersistenceDataRecreateServlet.class, path = APP_NAME + "_" + SPECLEVEL + "/" + SERVLET)
